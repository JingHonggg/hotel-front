  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        &nbsp;&nbsp;
        <el-input round v-model="rooms.roomId" placeholder="请输入房间号搜索,直接回车即可" class="handle-input mr10" clearable
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button plain type="primary" size="mini" icon="el-icon-lx-exit"
      ...
      <div class="pagination">
        <el-pagination background layout="total, prev, pager, next" :current-page="rooms.pageIndex"
          :page-size="rooms.pageSize" :total="pageTotal" @current-change="handlePageChange"></el-pagination>
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      saveRoomEdit() {
        ...
        this.$http.post('/addRoom?position=' + this.form.position + '&roomId=' + this.form.roomId + '&typeId=' + this
          .form.typeId).then(res => {
          console.log(res);
      ...
      // 搜索功能
      handleSearch() {
        this.$http.get('/getRoomById?id=' + this.rooms.roomId).then(res => {
