...
export default {
    ...
    methods: {
        ...
        saveBook() {
            ...
            if (days >= 1) {
                this.$http.post('/addBookMsg?contact=' + this.form.contact + '&fromTime=' + fromTime + '&id=0&idCard=' + this.form.idCard + '&name=' + this.form.name + '&toTime=' + toTime + '&rank=' + this.form.rank).then(res => {
                    //console.log(res);
                    if (res.data.code === 200) {
                        //1.提示成功
        ...
        CheckIn() {
            ...
            const days = Math.floor((toTime - fromTime) / (24 * 3600 * 1000));
            if (days >= 1) {
                this.$http.post('/checkIn?contact=' + this.form.contact + '&fromTime=' + fromTime + '&idCard=' + this.form.idCard + '&name=' + this.form.name + '&toTime=' + toTime + '&roomId=' + this.form.resultRoom).then(res => {
                    //console.log(res);
                    if (res.data.code === 200) {
                        //1.提示成功
