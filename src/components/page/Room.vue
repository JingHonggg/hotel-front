...
export default {
    ...
    methods: {
        ...
        sureCost (costTypesId) {
            ...
            this.$http.post('/addCost?costTypeId=' + costTypesId + '&id=0&roomId=' + this.costTypes.serviceNeedRooId).then(res => {
                console.log(res);
        ...
        saveRoomEdit () {
            ...
            if (this.form.maxNum > 0 && this.form.earnest > 0 && this.form.rent > 0 && this.form.size > 0) {
                this.$http.post('/addRoom?earnest=' + this.form.earnest + '&roomId=' + this.form.roomId + '&maxNum=' + this.form.maxNum + '&rank=' + this.form.rank + '&rent=' + this.form.rent + '&size=' + this.form.size + '&position=' + this.form.position).then(res => {
                    //console.log(res);
                    if (res.data.code === 200) {
                        //1.提示成功
        ...
        saveBook () {
            //console.log(this.form);
            this.$http.post('/addGuest?contact=' + this.form.contact + '&idCard=' + this.form.idCard + '&name=' + this.form.name).then(res => {
                //console.log(res);
                if (res.data.code === 200) {
                    //1.提示成功
                    this.$message.success(`添加成功`);
