      ...
      <el-row>
        ...
        <el-col :span="8">
          <div>
            ...
            <br />
            <span>营业状态：</span>
            <span v-if="result.sangna.status === 1">正在营业</span>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <div>
            ...
            <br />
            <span>营业状态：</span>
            <span v-if="result.jiuba.status === 1">正在营业</span>
            <span v-else>未营业</span>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <div>
            ...
            <br />
            <span>营业状态：</span>
            <span v-if="result.canting.status === 1">正在营业</span>
            <span v-else>未营业</span>
      ...
      <el-row>
        ...
        <el-col :span="19">
          <el-select v-model="formData.status" placeholder="请选择">
            <el-option label="正在开放" :value="1"></el-option>
            <el-option label="未开放" :value="2">
            </el-option>
          </el-select>
